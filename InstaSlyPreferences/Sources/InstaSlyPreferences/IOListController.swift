...
class IOListController: PSListController {
    ...
    let prefsPath = "/User/Library/Preferences/com.eamontracey.instaslypreferences.plist"
    ...
    override func setPreferenceValue(_ value: Any!, specifier: PSSpecifier!) {
        ...
        CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFNotificationName("com.eamontracey.instaslypreferences/update" as CFString), nil, nil, true)
    }
